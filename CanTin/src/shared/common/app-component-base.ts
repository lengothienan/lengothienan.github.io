...
import { UiCustomizationSettingsDto, DocumentStatusDto, DocumentStatusesServiceProxy, GetDocumentStatusForViewDto, RoleListDto } from '@shared/service-proxies/service-proxies';
...
export abstract class AppComponentBase {
    ...
    get currentRole(): number{
        return this.appSession.roleId;
    }
}
