...
import { ViewRoleMapperGroupModalComponent } from './qlvb/roleMapperGroups/view-roleMapperGroup-modal.component';
import { CreateOrEditRoleMapperGroupModalComponent } from './qlvb/roleMapperGroups/create-or-edit-roleMapperGroup-modal.component';
...
import { DxTextAreaModule, DxMenuModule, DxDataGridModule, DxButtonModule, DxCheckBoxModule, DxSelectBoxModule, DxTextBoxModule, DxProgressBarModule, DxPopupModule, DxTemplateModule, DxDateBoxModule, DxHtmlEditorModule, DxToolbarModule, DxButtonGroupModule, DxResizableModule, DxFileUploaderModule, DxTagBoxModule, DxListModule, DxScrollViewModule, DxTreeViewModule, DxContextMenuModule, DxPopoverModule, DxDropDownBoxModule, DxFormModule, DxFileManagerModule, DxNumberBoxModule, DxTreeListModule, DxValidatorModule, DxValidationSummaryModule, DxValidationGroupModule } from 'devextreme-angular';
import { UploadFileComponent } from './management/uploadFile/upload-modal';
import { UpdateCurrentIncommingNumberComponent } from './qlvb/updateIncommingNumber/update-incomming-number.component';
import { CreateOrEditDynamicLabelComponent } from './management/labels/create-or-edit-dynamicLabel.component';
import { CreateOrEditLabelFromHardDatasourceComponent } from './management/labels/create-or-edit-labelFromHardDatasource.component';
import { ViewLabelRoleComponent } from './management/labels/view-label-role.component';
import { TemplatesAdminComponent } from './management/templates/templates.component';
import { CreateOrEditTemplateAdminModalComponent } from './management/templates/create-or-edit-template-modal.component';
import { ViewTemplateAdminModalComponent } from './management/templates/view-template-modal.component';;
...
@NgModule({
    ...
    declarations: [
		...
		RoleMapperGroupsComponent,
		ViewRoleMapperGroupModalComponent,		CreateOrEditRoleMapperGroupModalComponent,
        CreateOrEditLabelFromHardDatasourceComponent,
        ...
        CreateOrEditDynamicLabelComponent,
		LabelsComponent,
		LabelsNewComponent,
        ...
        UploadFileComponent, UpdateCurrentIncommingNumberComponent,
        TemplatesAdminComponent, CreateOrEditTemplateAdminModalComponent, ViewTemplateAdminModalComponent
, CapnhatvanbanphongComponent
, UploadFileHdsdComponent
    ],
    exports: [
        AddMemberModalComponent,
        AddRoleModalComponent
