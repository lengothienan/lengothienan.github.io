...
import { CreateOrUpdateRoleInput, RoleEditDto, RoleGroupServiceProxy, RoleServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditRoleModalComponent extends AppComponentBase implements OnInit{
    ...
    constructor(
        ...
        private _roleGroupService: RoleGroupServiceProxy
    ) {
        super(injector);
    }

    ngOnInit(): void {
        this._roleGroupService.getAll().subscribe(res => {
            this.listRoleGroup = res.data;
        });
    }
