...
@Component({
    selector: 'createOrEditTemplateAdminModal',
    templateUrl: './create-or-edit-template-modal.component.html'
})
export class CreateOrEditTemplateAdminModalComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this._templatesServiceProxy.getAllOrganizationUnitsForAdmin().subscribe(result => {
            console.log(result);
            this.orgList = result;
        })
    }
