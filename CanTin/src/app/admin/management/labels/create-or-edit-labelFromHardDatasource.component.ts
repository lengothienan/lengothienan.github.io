...
import { LabelsServiceProxy, CreateOrEditLabelDto, LabelDto, MenusServiceProxy, MenuDto, DynamicDatasourceServiceProxy, GetDynamicDatasourceForViewDto } from '@shared/service-proxies/service-proxies';
import { AppComponentBase } from '@shared/common/app-component-base';
import * as moment from 'moment';


@Component({
    selector: 'createOrEditLabelFromHardDatasource',
    templateUrl: './create-or-edit-labelFromHardDatasource.component.html'
})
//component tạo mới danh mục động
export class CreateOrEditLabelFromHardDatasourceComponent extends AppComponentBase {
    ...
    menuOptions: MenuDto[] = [];
    dynamicDatasource: GetDynamicDatasourceForViewDto[] = [];
    dynamicDatasourceId: number;
    constructor(
        injector: Injector,
    ...
    setLink(){
        this.label.link = '/app/main/qlvb/datasource/' + this.dynamicDatasourceId;
    }
