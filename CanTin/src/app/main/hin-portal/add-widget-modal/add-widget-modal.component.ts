...
export class WidgetLayoutOutput {
  id!: string | undefined;
...
export class AddHinWidgetModalComponent extends AppComponentBase {

  @Output() onClose = new EventEmitter();
  @ViewChild('addWidgetModal', { static: true }) modal: ModalDirective;

  widgets: WidgetLayoutOutput[];
  saving = false;
  ...
  show(widgets: WidgetLayoutOutput[]): void {
