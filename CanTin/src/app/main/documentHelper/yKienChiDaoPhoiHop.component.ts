...
@Component({
    selector: 'yKienChiDaoPhoiHop',
    templateUrl: './yKienChiDaoPhoiHop.component.html',
    animations: [appModuleAnimation()]
})
//ý kiến chỉ đạo cho vb đến phòng
export class YKienChiDaoPhoiHopComponent extends AppComponentBase implements OnInit{
    ...
    save(){
        ...
        this._documentAppService.multipleCapNhatChiDaoPhongPhoiHop(this.capNhatDto)
        .pipe(finalize(() => {
