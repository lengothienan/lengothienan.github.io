...
import { DynamicDatasourceServiceProxy, DynamicDatasourceDto, DynamicDatasourceFromStoreDto  } from '@shared/service-proxies/service-proxies';
...
export class DynamicDatasourceComponent extends AppComponentBase implements OnInit{
    ...
    isActiveFilter = -1;
    tableResult: DynamicDatasourceFromStoreDto[] = [];

    dataSourceTypes = [
        'DataSource cứng', 'DataSource theo store', 'DataSource theo command'
    ];
    ...
    loadData(){
        this._dynamicDatasourceServiceProxy.getAllDyamicDatasourceFromStore().subscribe(res => {
