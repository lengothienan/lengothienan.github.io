...
import { HistoryUploadsServiceProxy, DocumentServiceProxy, Idoc_starsServiceProxy, CreateOrEditIdoc_starDto, DocumentHandlingsServiceProxy, DocumentHandlingDetailsServiceProxy, UserServiceProxy, DynamicGridHelperServiceProxy, DynamicFieldsServiceProxy, ListDVXL, GetUserInRoleDto, ODocsServiceProxy, ApproveDocumentDto, CapNhatInputDto } from '@shared/service-proxies/service-proxies';
...
import { YKienChiDaoVBComponent } from '../yKienChiDaoVB.component';
@Component({
    templateUrl: './chua-phan-xu-ly.component.html',
    styleUrls: ['./chua-phan-xu-ly.component.less'],
    animations: [appModuleAnimation()]
})
export class VBDenTuCacDoi_ChuaPhanXuLyComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('yKienChiDaoTeam', { static: false }) yKienChiDao: YKienChiDaoVBComponent;
    totalCount: number = 0;
    saving = false;
    rawSql: string;
    user_ID: any;
    ...
    loadData() {
        this._documentAppService.getAllDocumentFromTeams(this.appSession.selfOrganizationUnitId, 4).subscribe(res => {
    ...
    them_moi() {
        this.router.navigate(['/app/main/qlvb/them-vb-den-noi-bo']);
    }
    ...
    onExporting(e) {
        ...
        e.component.columnOption('PublisherName', 'visible', true);
        e.component.columnOption('PublishDate', 'visible', true);
        e.component.columnOption('IncommingDateDV', 'visible', true);
        e.component.columnOption('Deadline', 'visible', true);
    }
    onExported(e) {
        e.component.columnOption('PublisherName', 'visible', false);
        e.component.columnOption('PublishDate', 'visible', false);
        e.component.columnOption('IncommingDateDV', 'visible', false);
