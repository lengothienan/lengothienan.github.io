...
@Component({
    templateUrl: './chua-trinh-CH-phong.component.html',
    styleUrls: ['./chua-trinh-CH-phong.component.less'],
    animations: [appModuleAnimation()]
})
export class ChuaTrinhChiHuyPhongComponent extends AppComponentBase implements OnInit {
