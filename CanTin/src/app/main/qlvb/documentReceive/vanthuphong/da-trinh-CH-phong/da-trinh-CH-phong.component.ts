...
@Component({
    templateUrl: './da-trinh-CH-phong.component.html',
    styleUrls: ['./da-trinh-CH-phong.component.less'],
    animations: [appModuleAnimation()]
})
export class DaTrinhChiHuyPhongComponent extends AppComponentBase implements OnInit {
