...
@Component({
    templateUrl: './danh-sach-theo-phong.component.html',
    styleUrls: ['./danh-sach-theo-phong.component.less'],
    animations: [appModuleAnimation()]
})
export class DanhSachTheoPhongComponent extends AppComponentBase implements OnInit {
