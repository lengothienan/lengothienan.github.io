...
@Component({
    selector: 'xemVBDenPhongPH',
    templateUrl: './xem-vb-phong-ph.component.html',
...
export class ViewDocumentDenPhongPHComponent extends AppComponentBase implements OnInit{
    ...
    ngOnInit(){
        ...
        if(Id != null){
            ...
            this._documentAppService.getDocumentDtoByDocumentId(this.documentId, this.appSession.userId, handlingId).subscribe((result) => {
                ...
                this.yKienBGD = this.yKienBGD + this.documentData.approvingRecommended;
                this._documentHandlingAppService.get_DVXL_PH_ForDocument_Dept(result.id).subscribe((res) => {
                    this.old_DVXL = res;
                    debugger
