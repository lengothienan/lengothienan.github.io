...
@Component({
  selector: 'app-vb-phoihop-phong',
  templateUrl: './vb-phoihop-phong.component.html',
  styleUrls: ['./vb-phoihop-phong.component.css'],
  animations: [appModuleAnimation()]
})
export class VbPhoihopPhongComponent extends AppComponentBase implements OnInit {
  ...
  loadData(){
      this._documentAppService.getListVBPhoiHopPhong(this.appSession.organizationUnitId).subscribe(res => {

        console.log(this.appSession.selfOrganizationUnitId);
