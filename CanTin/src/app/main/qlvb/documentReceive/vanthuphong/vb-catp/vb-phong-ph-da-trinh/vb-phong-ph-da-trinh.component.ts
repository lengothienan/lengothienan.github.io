...
import { HistoryUploadsServiceProxy, DocumentServiceProxy, Idoc_starsServiceProxy, CreateOrEditIdoc_starDto, DocumentHandlingDetailDto, DocumentHandlingsServiceProxy, DocumentHandlingDetailsServiceProxy, UserServiceProxy, DynamicGridHelperServiceProxy, DynamicFieldsServiceProxy, DirectorOpinionDto, ListDVXL, ApproveDocumentDto, CapNhatInputDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './vb-phong-ph-da-trinh.component.html',
    styleUrls: ['./vb-phong-ph-da-trinh.component.less'],
    animations: [appModuleAnimation()]
})
export class VBCATPDenPhongPHDaTrinh extends AppComponentBase implements OnInit {
    ...
    loadData(){
        this._documentAppService.getListVBPHTuCATPDaCoChiDao(this.appSession.organizationUnitId).subscribe(res => {
    ...
    edit(e: any){
        this.router.navigate(['/app/main/qlvb/vb-phong/edit-ph/' + e]);
    }
