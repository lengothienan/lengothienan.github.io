...
import { HistoryUploadsServiceProxy, DocumentServiceProxy, Idoc_starsServiceProxy, CreateOrEditIdoc_starDto, DocumentHandlingDetailDto, DocumentHandlingsServiceProxy, DocumentHandlingDetailsServiceProxy, UserServiceProxy, DynamicGridHelperServiceProxy, DynamicFieldsServiceProxy, DirectorOpinionDto, ListDVXL, ApproveDocumentDto, CapNhatChiDaoDto, CapNhatInputDto, Comm_booksServiceProxy, PrintReportToLeaderDto } from '@shared/service-proxies/service-proxies';
...
import $ from 'jquery';
import { YKienChiDaoPHComponent } from '@app/main/documentHelper/yKienChiDaoPH.component';

@Component({
    templateUrl: './vb-phoihop-phong-chua-trinh.component.html',
    styleUrls: ['./vb-phoihop-phong-chua-trinh.component.less'],
    animations: [appModuleAnimation()]
})
export class VBPHCATPDenPhongChuaTrinh extends AppComponentBase implements OnInit {
    ...
    @ViewChild('yKienChiDao', { static: false}) yKienChiDao: YKienChiDaoPHComponent;
    ...
    loadData(){
        this._documentAppService.getListDocumentCATPPHChuaTrinh(this.appSession.organizationUnitId).subscribe(res => {
    ...
    viewRow(event: any) {
        ...
        this.router.navigate(['/app/main/qlvb/them-vb-phong/view-ph/' + event.Id]);
    }
    ...
    print(){
        const that = this;
        let data1 = this.selectedRowsData[0];
        ...
        $.ajax({
            ...
            data: {
                documentId: this.selectedRowsData[0].Id,
                ...
                position:  teamLeaderName.position, 
            ...
            success: function (data) {
                ...
                that.initialData[d]["BookDV"] = that.dataFilePhieuTrinh.bookDV;
                that.initialData[d]["IncommingDateDV"] = that.dataFilePhieuTrinh.incommingDateDV;
                that.initialData[d]["IncommingNumberDV"] = that.dataFilePhieuTrinh.incommingNumberDV;
