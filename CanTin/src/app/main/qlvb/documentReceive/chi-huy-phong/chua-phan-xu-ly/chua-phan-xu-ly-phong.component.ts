...
@Component({
    templateUrl: './chua-phan-xu-ly-phong.component.html',
    styleUrls: ['./chua-phan-xu-ly-phong.component.less'],
    animations: [appModuleAnimation()]
})
export class ChuaPhanXuLyPhongComponent extends AppComponentBase implements OnInit {
