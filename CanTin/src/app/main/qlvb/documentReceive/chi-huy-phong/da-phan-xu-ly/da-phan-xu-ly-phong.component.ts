...
@Component({
    templateUrl: './da-phan-xu-ly-phong.component.html',
    styleUrls: ['./da-phan-xu-ly-phong.component.less'],
    animations: [appModuleAnimation()]
})
export class DaPhanXuLyPhongComponent extends AppComponentBase implements OnInit {
