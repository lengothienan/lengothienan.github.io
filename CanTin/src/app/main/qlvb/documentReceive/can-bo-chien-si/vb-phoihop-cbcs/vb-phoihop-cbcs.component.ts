...
import $ from 'jquery';
@Component({
  selector: 'app-vb-phoihop-cbcs',
  templateUrl: './vb-phoihop-cbcs.component.html',
  styleUrls: ['./vb-phoihop-cbcs.component.css'],
  animations: [appModuleAnimation()]
})
export class VbPhoihopCbcsComponent extends AppComponentBase implements OnInit {
  ...
  loadData(){
      this._documentAppService.getListVBPhoiHopCBCS().subscribe(res => {
