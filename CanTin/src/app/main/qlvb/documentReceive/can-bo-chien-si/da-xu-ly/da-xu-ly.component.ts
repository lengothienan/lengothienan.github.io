...
@Component({
    templateUrl: './da-xu-ly.component.html',
    styleUrls: ['./da-xu-ly.component.less'],
    animations: [appModuleAnimation()]
})
export class DaXuLyComponent extends AppComponentBase implements OnInit {
    ...
    loadData(){
        this._documentAppService.getAllHandledIncommDocumentForIndividual().subscribe(res => {
