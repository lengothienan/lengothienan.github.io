...
@Component({
    templateUrl: './da-xu-ly-ph.component.html',
    styleUrls: ['./da-xu-ly-ph.component.less'],
    animations: [appModuleAnimation()]
})
export class DaXuLyPHComponent extends AppComponentBase implements OnInit {
    ...
    loadData(){
        this._documentAppService.getAllHandledIncommDocumentPHForIndividual().subscribe(res => {
