...
@Component({
    templateUrl: './chua-phan-xu-ly-doi-pho.component.html',
    styleUrls: ['./chua-phan-xu-ly-doi-pho.component.less'],
    animations: [appModuleAnimation()]
})
export class ChuaPhanXuLyDoiPhoComponent extends AppComponentBase implements OnInit {
