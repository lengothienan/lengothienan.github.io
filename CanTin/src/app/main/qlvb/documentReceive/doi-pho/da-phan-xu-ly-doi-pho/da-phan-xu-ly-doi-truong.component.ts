...
import { CachingServiceProxy, WebLogServiceProxy, AuditLogServiceProxy, HistoryUploadDto, HistoryUploadsServiceProxy, DocumentServiceProxy, Idoc_starsServiceProxy, CreateOrEditIdoc_starDto, DynamicActionsServiceProxy, DocumentHandlingDetailDto, DocumentHandlingsServiceProxy, DocumentsDto, DocumentHandlingDetailsServiceProxy, UserServiceProxy, DynamicGridHelperServiceProxy, DynamicFieldsServiceProxy, DirectorOpinionDto, ListDVXL, ApproveDocumentDto, ODocsServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './da-phan-xu-ly-doi-pho.component.html',
    styleUrls: ['./da-phan-xu-ly-doi-pho.component.less'],
    animations: [appModuleAnimation()]
})
export class DaPhanXuLyDoiPhoComponent extends AppComponentBase implements OnInit {
    ...
    data_cbcs = [
        // {displayName: 'Nguyễn Văn A', shortentCode: 'CB1', mainHandling: false, coHandling: false, unitId: 1},
        // {displayName: 'Nguyễn Văn B', shortentCode: 'CB2', mainHandling: false, coHandling: false, unitId: 2},
        // {displayName: 'Nguyễn Văn C', shortentCode: 'CB3', mainHandling: false, coHandling: false, unitId: 3},
        // {displayName: 'Nguyễn Văn D', shortentCode: 'CB4', mainHandling: false, coHandling: false, unitId: 4},
        // {displayName: 'Nguyễn Văn E', shortentCode: 'CB5', mainHandling: false, coHandling: false, unitId: 5}
    ];
    ...
    constructor(
        ...
        this._oDocsServiceProxy.getUserInRoleByOrg(this.appSession.selfOrganizationUnitId, '').subscribe(res => {
            this.data_cbcs = res.filter(x => x.roleCode == 'CB');
            this.data_cbcs.forEach(x => {
