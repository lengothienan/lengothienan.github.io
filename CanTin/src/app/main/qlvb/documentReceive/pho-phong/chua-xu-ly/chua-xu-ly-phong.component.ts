...
@Component({
    templateUrl: './chua-xu-ly-phong.component.html',
    styleUrls: ['./chua-xu-ly-phong.component.less'],
    animations: [appModuleAnimation()]
})
export class ChuaXuLyPhoPhongComponent extends AppComponentBase implements OnInit {
