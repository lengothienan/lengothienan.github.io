...
@Component({
    templateUrl: './da-xu-ly-phong.component.html',
    styleUrls: ['./da-xu-ly-phong.component.less'],
    animations: [appModuleAnimation()]
})
export class DaXuLyPhoPhongComponent extends AppComponentBase implements OnInit {
