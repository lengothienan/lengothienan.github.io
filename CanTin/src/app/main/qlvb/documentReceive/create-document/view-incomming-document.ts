...
import { DocumentsDto, DocumentTypeDto, DocumentTypesServiceProxy, DocumentServiceProxy, PriorityDto, TextBookDto, DynamicFieldsServiceProxy, HandlingUser, DocumentHandlingsServiceProxy, DocumentForViewDto, Comm_booksServiceProxy, CA_DocumentHandlingUserServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    ...
    templateUrl: './view-incomming-document.html',
...
export class ViewIncommingDocumentComponent extends AppComponentBase implements OnInit{
    ...
    constructor(
        ...
        this.printUrl = AppConsts.remoteServiceBaseUrl + '/ExportFile/GetWordFile';
    ...
    ngOnInit(){
        ...
        if(Id != null){
            ...
            this._documentAppService.getDocumentViewByDocumentId(this.documentId).subscribe((result) => {
