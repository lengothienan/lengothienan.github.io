...
@Component({
    selector: 'traCuuVBPhong',
    templateUrl: './tra-cuu-vb-phong.component.html',
    styleUrls: ['./tra-cuu-vb-phong.component.less'],
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe] ,
    animations: [appModuleAnimation()]

})
export class TraCuuVBPhongComponent extends AppComponentBase {
