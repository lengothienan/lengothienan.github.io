...
import $ from 'jquery';
import { DxFormComponent, DxDataGridComponent, DxButtonComponent, DxSwitchComponent, DxNumberBoxComponent, DxDateBoxComponent, DxSelectBoxComponent, DxTabPanelComponent } from 'devextreme-angular';
...
@Component({
    selector: 'themMoiVBDenPhong',
    templateUrl: './them-moi-vb-phong.component.html',
...
export class ThemMoiVBDenPhongComponent extends AppComponentBase implements OnInit{
    ...
    constructor(
        ...
        private _publishOrgService: PublishOrgsServiceProxy
    ) {
        super(injector);
    ...
    getCurrentTab(){
        console.log(this.tabPanel.selectedIndex);
    }
