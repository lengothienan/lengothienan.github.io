...
@Component({
    templateUrl: './chua-phan-xu-ly-ph-doi-truong.component.html',
    styleUrls: ['./chua-phan-xu-ly-ph-doi-truong.component.less'],
    animations: [appModuleAnimation()]
})
export class ChuaPhanXuLyPHDoiTruongComponent extends AppComponentBase implements OnInit {
    ...
    loadData(){
        ...
        this._documentAppService.getAllDocumentPHHaveDirectedToTeam(this.appSession.selfOrganizationUnitId,4).subscribe(res => {
    ...
    view(e: any){
        ...
        this.router.navigate(['/app/main/qlvb/them-vb-phong/view-ph/' + e.Id]);
    }
