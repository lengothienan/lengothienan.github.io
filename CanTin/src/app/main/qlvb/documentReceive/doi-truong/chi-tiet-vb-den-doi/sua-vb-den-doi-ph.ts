...
@Component({
    selector: 'suaVBDenPhongExtraPHComponent',
    templateUrl: './sua-vb-den-doi-ph.html',
...
export class EditDocumentDenDoiPHComponent extends AppComponentBase implements OnInit{
