...
@Component({
  selector: 'app-vb-phoihop-doi',
  templateUrl: './vb-phoihop-doi.component.html',
  styleUrls: ['./vb-phoihop-doi.component.css'],
  animations: [appModuleAnimation()]
})
export class VbPhoihopDoiComponent extends AppComponentBase implements OnInit {
  ...
  loadData() {
      this._documentAppService.getListVBPhoiHopDoi(this.appSession.selfOrganizationUnitId).subscribe(res => {
