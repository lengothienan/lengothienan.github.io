...
@Component({
    templateUrl: './chua-phan-xu-ly-to-truong.component.html',
    styleUrls: ['./chua-phan-xu-ly-to-truong.component.less'],
    animations: [appModuleAnimation()]
})
export class ChuaPhanXuLyToTruongComponent extends AppComponentBase implements OnInit {
