...
@Component({
    templateUrl: './da-phan-xu-ly-to-truong.component.html',
    styleUrls: ['./da-phan-xu-ly-to-truong.component.less'],
    animations: [appModuleAnimation()]
})
export class DaPhanXuLyToTruongComponent extends AppComponentBase implements OnInit {
