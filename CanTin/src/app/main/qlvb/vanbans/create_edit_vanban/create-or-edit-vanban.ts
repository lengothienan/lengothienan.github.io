...
@Component({
    selector: 'createOrEditVanban',
    templateUrl: './create-or-edit-vanban.html',
     preserveWhitespaces: true,
     animations: [appModuleAnimation()]
})
export class CreateOrEditVanbanComponent extends AppComponentBase implements  OnInit {
  ...
  @ViewChild(DxDataGridComponent, { static: false }) dataGrid: DxDataGridComponent;
    ...
    constructor(
        ...
        super(injector);
        this.newvanban = {};
        this.uploadUrl = AppConsts.fileServerUrl  + '/fileupload/Upload_file' ;
  ...
  //  
        this.activeRoute.params.subscribe(params => {
          ...
          if(this._id !== undefined){
            this._vanbansServiceProxy.getVanbanForView(this._id).subscribe((res) => {
              this.newvanban = res.vanban;
