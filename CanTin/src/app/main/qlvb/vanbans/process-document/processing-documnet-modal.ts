...
@Component({
    selector: 'processingDocumnetModal',
    templateUrl: './processing-documnet-modal.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]

})
export class ProcessingDocumnetModalComponent extends AppComponentBase {
    @ViewChild('dataTable', { static: true }) dataTable: Table;
    @ViewChild('paginator', { static: true }) paginator: Paginator;

    scheduleData: DocumentsDto;
    listChildSchedule: any;
