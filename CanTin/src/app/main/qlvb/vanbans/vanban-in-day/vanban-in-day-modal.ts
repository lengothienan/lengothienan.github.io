...
@Component({
    selector: 'vanbanInDayModal',
    templateUrl: './vanban-in-day-modal.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]

})
export class VanbanInDayModalComponent extends AppComponentBase {
    ...
    addReceptionOfTheDay()
    {
        this.router.navigate(['/app/main/qlvb/reception-of-the-day']);
    }
