...
@Component({
    templateUrl: './danh-sach-vb-chua-phuc-dap.html',
    styleUrls: ['./danh-sach-vb-chua-phuc-dap.less'],
    animations: [appModuleAnimation()]
})
export class DanhSachVBChuaPhucDapComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit() {
        ...
        // });
        this._oDocsServiceProxy.getListDocumentToCATPWaitingResponse().subscribe(res => {
    ...
    phucDap(data){
        debugger
        this.utility.selectedDocumentData = data;
    ...
    choSo(e){
        // let temp = this.selectedRowsData[0].Id + ";" + this.selectedRowsData[0].IncommingNumber;
        this.utility.selectedDocumentData = this.selectedRowsData[0];
        this.router.navigate(['/app/main/qlvb/them-moi-va-cho-so']);
    }
    ...
    onExporting(e){
        ...
        e.component.columnOption('number_incomingdated', 'visible', true);
        e.component.columnOption('bgd', 'visible', true);
    }
    onExported(e){  
        e.component.columnOption('number_publishdate', 'visible', false);
        e.component.columnOption('number_incomingdated', 'visible', false);
