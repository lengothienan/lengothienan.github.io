...
@Component({
    templateUrl: './danh-sach-vb-cho-phe-duyet.component.html',
    styleUrls: ['./danh-sach-vb-cho-phe-duyet.component.less'],
    animations: [appModuleAnimation()]
})
export class DanhSachVBChoPheDuyetComponent extends AppComponentBase implements OnInit {
    ...
    data_pheDuyet = [{id: 1, name: 'Duyệt'}, {id: 2, name: 'Không Duyệt'}];
    ...
    pheDuyet(){
        this.popup_pheDuyet = true;
    }

    pheDuyetSave(){
        this.popup_pheDuyet = false;
    }
