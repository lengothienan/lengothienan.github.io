...
@Component({
    templateUrl: './danh-sach-vb-khong-duyet.component.html',
    styleUrls: ['./danh-sach-vb-khong-duyet.component.less'],
    animations: [appModuleAnimation()]
})
export class DanhSachVBKhongDuyetComponent extends AppComponentBase implements OnInit {
