...
@Component({
    ...
    templateUrl: './chuyen-vtcatp-phat-hanh.html',
...
export class ThemMoiVBDiChuyenVTCATPComponent extends AppComponentBase {
    ...
    save(): void {
		...
		//fix Không chuyển trạng thái khi chưa phát hành
                this.documentData.cA_Status = false;
            ...
            this._oDocsServiceProxy.oDocTuDoiTransferToCATP(this.documentData)
            .pipe(finalize(() => {
                self.saving = false;
    ...
    selectReplyDocument() {
        this.searchDocumentDonViModal.type=0;
