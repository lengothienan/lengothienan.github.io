...
export class DanhSachVBDaPhatHanhDonviGuiDonViKhacComponent extends AppComponentBase implements OnInit {
    ...
    search(){
        this._oDocsServiceProxy.getAllPublishedDocumentSendToOtherOrg(this.appSession.organizationUnitId,this.documentSearchData["book"] ==null?-1:this.documentSearchData["book"]).subscribe(res => {
    ...
    onExporting(e){
        ...
        e.component.columnOption('linkedDocNumber', 'visible', true);
        e.component.columnOption('number_publishdate', 'visible', true);
    }
    onExported(e){  
        // e.component.columnOption('DoiPhoiHop', 'visible', false);
        e.component.columnOption('linkedDocNumber', 'visible', false);
