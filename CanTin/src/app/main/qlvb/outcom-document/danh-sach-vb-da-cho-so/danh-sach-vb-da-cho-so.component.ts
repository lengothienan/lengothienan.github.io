...
@Component({
    templateUrl: './danh-sach-vb-da-cho-so.component.html',
    styleUrls: ['./danh-sach-vb-da-cho-so.component.less'],
    animations: [appModuleAnimation()]
})
export class DanhSachVBDaChoSoComponent extends AppComponentBase implements OnInit {
    ...
    search() {
        this._oDocsServiceProxy.getListDocumentCATPDaPhatHanh(this.documentSearchData["book"]).subscribe(result => { this.initialData = result; });
    }
