...
@Component({
    selector: 'xemVbDaChoSo',
    templateUrl: './xem-vb-da-cho-so.html',
    styleUrls: ['./xem-vb-da-cho-so.less'],
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe] ,
    animations: [appModuleAnimation()]

})
export class XemVanBanDaChoSoComponent extends AppComponentBase {
    ...
    constructor(
        ...
        //         if(events[0].urlAfterRedirects.includes('danh-sach-vb-chua-phuc-dap-cua-donvi-tu-donvi-khac')){
        //             this.header = "Thêm mới VB gửi các đơn vị khác";
        //             this.isNotCATP = true;
        //         }
        // });
    ...
    ngOnInit(){
        ...
        console.log("isCATP = " + this.appSession.isCATP);
        ...
        if(this.utility.selectedDocumentData != null && this.utility.selectedDocumentData != undefined){
            ...
            this.documentData.orgEditor = this.selectedDocumentData.InitIdChuTri;
        }
        else {
        ...
        this._commBookServiceProxy.getAllCommBookInDepartment("2", this.appSession.organizationUnitId).subscribe(result => {
        ...
        if(Id != null || Id != undefined){
            ...
            if(window.history.length == 1) {
                ...
                this.buttonText = "Trở về"
            }
            // that.isDraftNumberDisabled = true;
            ...
            this.getUserInDept();
            // this.radio_nguoi_ky();
            this._oDocServiceProxy.getDraftNumberOfCommBook(this.appSession.organizationUnitId).subscribe(res => {
            });
        }
        ...
        this._documentAppService.getListPhongBanCATP().subscribe(res =>{
            ...
            // ;
            // if(this.selectedDocumentData !== null || this.selectedDocumentData !== undefined){
            //     this.documentData.orgEditor = this.selectedDocumentData.unitIdChuTri;
            // }
        });
        
        // this._oDocServiceProxy.getListReceiver().subscribe(res => {
    ...
    initDraftNumBerChkBoxOptions(){
        ...
        this.draftNumBerChkBoxOptions = {
            ...
            readOnly: temp,
            onValueChanged: function(e){
                that.isDraftNumberDisabled = e.value;
                if(e.value == true){
                }
