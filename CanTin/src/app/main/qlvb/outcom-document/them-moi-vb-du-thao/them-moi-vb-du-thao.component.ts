...
@Component({
    ...
    templateUrl: './them-moi-vb-du-thao.component.html',
    styleUrls: ['./them-moi-vb-du-thao.component.less'],
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe] ,
    animations: [appModuleAnimation()]

})
export class ThemMoiVBDiComponent extends AppComponentBase {
    ...
    data_commBook = [];
    // cấp gửi
    data_groupAuthor = ['CATP', 'Phòng ban', 'Đội'];
    data_department = [];
    _id: number;
    data_secretLevel = [];
    data_priority = [];
