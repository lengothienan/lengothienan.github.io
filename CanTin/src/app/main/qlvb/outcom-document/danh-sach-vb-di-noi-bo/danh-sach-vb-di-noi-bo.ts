...
@Component({
    templateUrl: './danh-sach-vb-di-noi-bo.html',
    animations: [appModuleAnimation()]
})
export class DanhSachVBDiNoiBoComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit() {
        ...
        // });
        //this._oDocsServiceProxy.getListDocumentCATPDaPhatHanh().subscribe(result => {this.initialData = result;});
        ...
        // }
        // else {
        //     this._oDocsServiceProxy.getAllOutDocumentByOrgIdAndTypeHandling(this.appSession.organizationUnitId, 3, 2).subscribe(res => {
        //         this.initialData = res;
        //     });
        // }
        // this.innitBookOption() ;
        this._oDocsServiceProxy.getListVBDiDoiChuyenNoiBo(this.appSession.selfOrganizationUnitId).subscribe(result => { this.initialData = result; console.log(result); });
    ...
    view(e: any) {
        this.router.navigate(['/app/main/qlvb/oDocs/xem-vb-di-noi-bo/' + e]);
    }
