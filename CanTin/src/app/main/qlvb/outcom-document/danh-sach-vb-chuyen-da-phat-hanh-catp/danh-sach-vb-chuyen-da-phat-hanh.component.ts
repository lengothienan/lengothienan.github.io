...
@Component({
    templateUrl: './danh-sach-vb-chuyen-da-phat-hanh.component.html',
    styleUrls: ['./danh-sach-vb-chuyen-da-phat-hanh.component.less'],
    animations: [appModuleAnimation()]
})
export class DanhSachVBChuyenDaPhatHanhComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit() {
        ...
        this._oDocsServiceProxy.getAllOutDocumentByOrgIdAndTypeHandling(this.appSession.organizationUnitId, 4, 2).subscribe(res => {
    ...
    view(e: any){
        this.router.navigate(['/app/main/qlvb/oDocs/view/' + e]);
    }
