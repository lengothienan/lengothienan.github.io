...
@Component({
    templateUrl: './chua-luu-tru.component.html',
    styleUrls: ['./chua-luu-tru.component.less'],
    animations: [appModuleAnimation()]
})
export class ChuaLuuTruComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit() {
        ...
        this._oDocsServiceProxy.getAllOutDocumentByCBLT(3).subscribe(res => {
    ...
    view(e: any){
        this.router.navigate(['/app/main/qlvb/oDocs/luu-tru/' + e.data.Id]);
    }
    ...
    luuTru(e: any){
        this.router.navigate(['/app/main/qlvb/luu-tru/' + e]);
    }
}