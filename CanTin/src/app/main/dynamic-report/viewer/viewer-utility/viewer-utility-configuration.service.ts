...
export class ComponentViewDefinition {
    name: string;
    code: string;
    component: any;
...
export class ViewerUtilityConfigurationService {
  public ComponentViewDefinitions: ComponentViewDefinition[] = [];
  ...
  // let wdigetCloneRoleMapperGroup = new ComponentViewDefinition(
