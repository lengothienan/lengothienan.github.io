...
import {
    ...
    CreateOrEditSqlConfigDetailDto
...
export class ModifySqlConfigDetailsComponent extends AppComponentBase
    ...
    // @ViewChild("data1table", { static: true }) data1table: DxDataGridComponent;
    @ViewChild(DxDataGridComponent, { static: false }) data1table: DxDataGridComponent;
    ...
    currentTab: number;
    searchData: any;
    dataSource_Tab1: CreateOrEditSqlConfigDetailDto = new CreateOrEditSqlConfigDetailDto();
    dataSourceTab2: any;
    columnItems: any = [];
    dataSourceTest3: any;
    dataTemp = [];
    ...
    sqlContent = "";
    parentOptions: any;
    dataSource: CreateOrEditSqlConfigDetailDto[] = [];
    //key: any;
    //modalAdd: any;
    reportName: any;
    formData: any = [];
    ...
    dataSource2 : CreateOrEditSqlConfigDetailDto[] = [];
    dataSourceTab1 : CreateOrEditSqlConfigDetailDto[] = [];
    textAlignment = [
        {
            key: "center",
            display: "Center"
    ...
    ngOnInit() {
        ...
        this.dataSourceTab1.push(new CreateOrEditSqlConfigDetailDto());
    }
                ...
                const promise = new Promise((resolve, reject) => {
                    self._sqlConfigDetailsService
                        ...
                        .subscribe(res => {
                            ...
                            // self.data2table.instance.addRow();
                            // self.dataSourceTab2.push(new CreateOrEditSqlConfigDetailDto());
                        });
                });
                return promise;
            },
    ...
    save() {
        ...
        // console.log(self.columnItems);
        // console.log(this.currentReportId);
        // console.log(self.sqlContent);
    ...
    onCreateColumnRowUpdating(e) {
        ...
        let data = new CreateOrEditSqlConfigDetailDto();
        data.code = e.newData.code;
        data.isDisplay = e.newData.isDisplay;
        data.sqlConfigId = this.id;
        data.cellTemplate = e.newData.cellTemplate;
        data.name = e.newData.name;

        this._sqlConfigDetailsServiceProxy.createOrEdit(data)
             .pipe(finalize(() => { this.saving = false;}))
             .subscribe(() => {
                this.notify.info(this.l('Thêm cột mới thành công'));
                // this.close();
